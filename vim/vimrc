...
if g:iswindows
    " 将 vimfile 添加到 PATH 变量，便于调用 ctags 与 cscope
    let $PATH .= ";".$VIM."\\vimfiles"
    " 设置终端屏幕编码
...
Plugin 'a.vim'                           " 快速切换.h和.cpp文件
" Plugin 'derekwyatt/vim-fswitch'
" Plugin 'Align'                           " 提供对齐文字的功能，不同于indent插件，一旦用到就会非常方便
Plugin 'jiangmiao/auto-pairs'            " 一款简单的括号匹配插件 
...
Plugin 'Mark--Karkat'                    " 给不同的单词高亮
Plugin 'Shougo/neocomplcache.vim'
Plugin 'scrooloose/nerdcommenter'        " 快速注释/反注释代码块 
Plugin 'scrooloose/nerdtree'             " 展示文件/目录列表
Plugin 'OmniCppComplete'                 " 提供C++代码的自动补全功能
...
Plugin 'std_c.zip'
Plugin 'tpope/vim-surround'              " 快速给单词/句子两边增加符号（包括html标签） 
Plugin 'scrooloose/syntastic'            " 语法检查 
Plugin 'majutsushi/tagbar'
Plugin 'taglist.vim'                     " 单个源代码文件的函数列表之类的功能 
Plugin 'TxtBrowser'
Plugin 'ZoomWin'
Plugin 'fatih/vim-go'
Plugin 'godlygeek/tabular'
Plugin 'nathanaelkane/vim-indent-guides' " 帮助缩进对齐 
Plugin 'UltiSnips'                       " 超强的快速生成代码段的功能(超越snipmate)
Plugin 'AuthorInfo'                      " 自动生成/更新文件的作者信息
Plugin 'matchit.zip'                     " 使%不仅能够匹配简单的<>()，还能匹配<html></html>之类标签的功能
" Plugin 'xml.vim'                         " 快速编写xml/html，如标签自动闭合等
" Plugin 'conque_shell'                    " 在vim中打开终端
Plugin 'vimwiki'                         " 个人wiki 
" Plugin 'VOoM'                            " outline功能 need python
Plugin 'hotoo/pangu.vim'
" ====================
" Color Scheme
Plugin 'Color-Scheme-Explorer'           " 列出配色列表 
...
let g:indent_guides_enable_on_vim_startup=1      "随 Vim 自动启动
...
" -----------------------------------------------------------------------------
" 自动生成/更新文件的作者信息
let g:vimrc_author='Yinr'
let g:vimrc_email='hsshuyin@qq.com'
...
set incsearch                                       "在输入要搜索的文字时，取消实时匹配
